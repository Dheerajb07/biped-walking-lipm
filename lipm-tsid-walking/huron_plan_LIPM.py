...
# --------------------------------------------
[P_ps, P_vs, P_pu, P_vu] = motion_model.compute_recursive_matrices(conf.dt_mpc, conf.g, conf.h, N)
...
[A_zmp, b_zmp] = constraints.add_ZMP_constraints(N, foot_length, foot_width, cop_ref, x_0, y_0)
...
# -------------------------------------------------
plot_utils.plot_x(
   time, N, min_admissible_CoP, max_admissible_cop, cop_x, com_state_x, cop_ref
)
